...
namespace MarvelComics.PCL.Controllers
{
    public partial class EventsController: BaseController
    {
        ...
        /// </summary>
        /// <param name="eventId">Required parameter: A single event.</param>
        /// <return>Returns the Event response from the API call</return>
        public Event GetEventIndividual(string eventId)
        {
            Task<Event> t = GetEventIndividualAsync(eventId);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="eventId">Required parameter: A single event.</param>
        /// <return>Returns the Event response from the API call</return>
        public async Task<Event> GetEventIndividualAsync(string eventId)
        {
            ...
            try
            {
                return APIHelper.JsonDeserialize<Event>(_response.Body);
            }
            catch (Exception _ex)
            {
        ...
        public CharacterDataWrapper GetEventCharacterCollection(
                ...
                string stories = null)
        {
            Task<CharacterDataWrapper> t = GetEventCharacterCollectionAsync(eventId, comics, limit, modifiedSince, name, nameStartsWith, offset, orderBy, series, stories);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="stories">Optional parameter: Return only characters which appear the specified stories (accepts a comma-separated list of ids).</param>
        /// <return>Returns the CharacterDataWrapper response from the API call</return>
        public async Task<CharacterDataWrapper> GetEventCharacterCollectionAsync(
                string eventId,
                string comics = null,
                string limit = null,
                string modifiedSince = null,
        ...
        public ComicDataWrapper GetComicsCollectionByEventId(
                ...
                string upc = null)
        {
            Task<ComicDataWrapper> t = GetComicsCollectionByEventIdAsync(eventId, characters, collaborators, creators, dateDescriptor, dateRange, diamondCode, digitalId, ean, events, format, formatType, hasDigitalIssue, isbn, issn, issueNumber, limit, modifiedSince, noVariants, offset, orderBy, series, sharedAppearances, startYear, stories, title, titleStartsWith, upc);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="upc">Optional parameter: Filter by UPC.</param>
        /// <return>Returns the ComicDataWrapper response from the API call</return>
        public async Task<ComicDataWrapper> GetComicsCollectionByEventIdAsync(
                string eventId,
                string characters = null,
                string collaborators = null,
                string creators = null,
        ...
        public CreatorDataWrapper GetCreatorCollectionByEventId(
                ...
                string suffix = null)
        {
            Task<CreatorDataWrapper> t = GetCreatorCollectionByEventIdAsync(eventId, comics, firstName, firstNameStartsWith, lastName, lastNameStartsWith, limit, middleName, middleNameStartsWith, modifiedSince, nameStartsWith, offset, orderBy, series, stories, suffix);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="suffix">Optional parameter: Filter by suffix or honorific (e.g. Jr., Sr.).</param>
        /// <return>Returns the CreatorDataWrapper response from the API call</return>
        public async Task<CreatorDataWrapper> GetCreatorCollectionByEventIdAsync(
                string eventId,
                string comics = null,
                string firstName = null,
                string firstNameStartsWith = null,
        ...
        public SeriesDataWrapper GetEventSeriesCollection(
                ...
                string titleStartsWith = null)
        {
            Task<SeriesDataWrapper> t = GetEventSeriesCollectionAsync(eventId, characters, comics, contains, creators, limit, modifiedSince, offset, orderBy, seriesType, startYear, stories, title, titleStartsWith);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="titleStartsWith">Optional parameter: Return series with titles that begin with the specified string (e.g. Sp).</param>
        /// <return>Returns the SeriesDataWrapper response from the API call</return>
        public async Task<SeriesDataWrapper> GetEventSeriesCollectionAsync(
                string eventId,
                string characters = null,
                string comics = null,
                string contains = null,
        ...
        public StoryDataWrapper GetEventStoryCollection(
                ...
                string series = null)
        {
            Task<StoryDataWrapper> t = GetEventStoryCollectionAsync(eventId, characters, comics, creators, limit, modifiedSince, offset, orderBy, series);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="series">Optional parameter: Return only stories contained the specified series (accepts a comma-separated list of ids).</param>
        /// <return>Returns the StoryDataWrapper response from the API call</return>
        public async Task<StoryDataWrapper> GetEventStoryCollectionAsync(
                string eventId,
                string characters = null,
                string comics = null,
                string creators = null,
        ...
        /// <param name="name">Optional parameter: Return only events which match the specified name.</param>
        ...
        /// <param name="stories">Optional parameter: Return only events which take place in the specified stories (accepts a comma-separated list of ids).</param>
        ...
        public EventDataWrapper GetEventsCollection(
                ...
                string stories = null)
        {
            Task<EventDataWrapper> t = GetEventsCollectionAsync(characters, comics, creators, limit, modifiedSince, name, nameStartsWith, offset, orderBy, series, stories);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="stories">Optional parameter: Return only events which take place in the specified stories (accepts a comma-separated list of ids).</param>
        /// <return>Returns the EventDataWrapper response from the API call</return>
        public async Task<EventDataWrapper> GetEventsCollectionAsync(
                string characters = null,
                string comics = null,
                string creators = null,
                string limit = null,
