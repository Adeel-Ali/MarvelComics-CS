...
{
    public partial class CharactersController: BaseController
    {
        ...
        /// </summary>
        internal static CharactersController Instance
        {
            get
            {
                lock (syncObject)
        ...
        /// </summary>
        /// <param name="characterId">Required parameter: A single character id.</param>
        /// <return>Returns the Character response from the API call</return>
        public Character GetCharacterIndividual(string characterId)
        {
            Task<Character> t = GetCharacterIndividualAsync(characterId);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="characterId">Required parameter: A single character id.</param>
        /// <return>Returns the Character response from the API call</return>
        public async Task<Character> GetCharacterIndividualAsync(string characterId)
        {
            ...
            try
            {
                return APIHelper.JsonDeserialize<Character>(_response.Body);
            }
            catch (Exception _ex)
            {
        ...
        public ComicDataWrapper GetComicsCharacterCollection(
                ...
                string upc = null)
        {
            Task<ComicDataWrapper> t = GetComicsCharacterCollectionAsync(characterId, collaborators, creators, dateDescriptor, dateRange, diamondCode, digitalId, ean, events, format, formatType, hasDigitalIssue, isbn, issn, issueNumber, limit, modifiedSince, noVariants, offset, orderBy, series, sharedAppearances, startYear, stories, title, titleStartsWith, upc);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="upc">Optional parameter: Filter by UPC.</param>
        /// <return>Returns the ComicDataWrapper response from the API call</return>
        public async Task<ComicDataWrapper> GetComicsCharacterCollectionAsync(
                string characterId,
                string collaborators = null,
                string creators = null,
                DateDescriptorEnum? dateDescriptor = null,
        ...
        public EventDataWrapper GetCharacterEventsCollection(
                ...
                string stories = null)
        {
            Task<EventDataWrapper> t = GetCharacterEventsCollectionAsync(characterId, comics, creators, limit, modifiedSince, name, nameStartsWith, offset, orderBy, series, stories);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="stories">Optional parameter: Return only events which contain the specified stories (accepts a comma-separated list of ids).</param>
        /// <return>Returns the EventDataWrapper response from the API call</return>
        public async Task<EventDataWrapper> GetCharacterEventsCollectionAsync(
                string characterId,
                string comics = null,
                string creators = null,
                string limit = null,
        ...
        public SeriesDataWrapper GetCharacterSeriesCollection(
                ...
                string titleStartsWith = null)
        {
            Task<SeriesDataWrapper> t = GetCharacterSeriesCollectionAsync(characterId, comics, contains, creators, events, limit, modifiedSince, offset, orderBy, seriesType, startYear, stories, title, titleStartsWith);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="titleStartsWith">Optional parameter: Return series with titles that begin with the specified string (e.g. Sp).</param>
        /// <return>Returns the SeriesDataWrapper response from the API call</return>
        public async Task<SeriesDataWrapper> GetCharacterSeriesCollectionAsync(
                string characterId,
                string comics = null,
                string contains = null,
                string creators = null,
        ...
        public StoryDataWrapper GetCharacterStoryCollection(
                ...
                string series = null)
        {
            Task<StoryDataWrapper> t = GetCharacterStoryCollectionAsync(characterId, comics, creators, events, limit, modifiedSince, offset, orderBy, series);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="series">Optional parameter: Return only stories contained the specified series (accepts a comma-separated list of ids).</param>
        /// <return>Returns the StoryDataWrapper response from the API call</return>
        public async Task<StoryDataWrapper> GetCharacterStoryCollectionAsync(
                string characterId,
                string comics = null,
                string creators = null,
                string events = null,
        ...
        /// <param name="events">Optional parameter: Return only characters which appear in the specified events (accepts a comma-separated list of ids).</param>
        /// <param name="limit">Optional parameter: Limit the result set to the specified number of resources.</param>
        ...
        public CharacterDataWrapper GetCharacterCollection(
                ...
                string stories = null)
        {
            Task<CharacterDataWrapper> t = GetCharacterCollectionAsync(comics, events, limit, modifiedSince, name, nameStartsWith, offset, orderBy, series, stories);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="stories">Optional parameter: Return only characters which appear the specified stories (accepts a comma-separated list of ids).</param>
        /// <return>Returns the CharacterDataWrapper response from the API call</return>
        public async Task<CharacterDataWrapper> GetCharacterCollectionAsync(
                string comics = null,
                string events = null,
                string limit = null,
                string modifiedSince = null,
