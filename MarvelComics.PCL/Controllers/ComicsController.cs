...
{
    public partial class ComicsController: BaseController
    {
        ...
        /// </summary>
        internal static ComicsController Instance
        {
            get
            {
                lock (syncObject)
        ...
        /// </summary>
        /// <param name="comicId">Required parameter: A single comic.</param>
        /// <return>Returns the Comic response from the API call</return>
        public Comic GetComicIndividual(string comicId)
        {
            Task<Comic> t = GetComicIndividualAsync(comicId);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="comicId">Required parameter: A single comic.</param>
        /// <return>Returns the Comic response from the API call</return>
        public async Task<Comic> GetComicIndividualAsync(string comicId)
        {
            ...
            try
            {
                return APIHelper.JsonDeserialize<Comic>(_response.Body);
            }
            catch (Exception _ex)
            {
        ...
        public CharacterDataWrapper GetComicCharacterCollection(
                ...
                string stories = null)
        {
            Task<CharacterDataWrapper> t = GetComicCharacterCollectionAsync(comicId, events, limit, modifiedSince, name, nameStartsWith, offset, orderBy, series, stories);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="stories">Optional parameter: Return only characters which appear the specified stories (accepts a comma-separated list of ids).</param>
        /// <return>Returns the CharacterDataWrapper response from the API call</return>
        public async Task<CharacterDataWrapper> GetComicCharacterCollectionAsync(
                string comicId,
                string events = null,
                string limit = null,
                string modifiedSince = null,
        ...
        public CreatorDataWrapper GetCreatorCollectionByComicId(
                ...
                string suffix = null)
        {
            Task<CreatorDataWrapper> t = GetCreatorCollectionByComicIdAsync(comicId, comics, firstName, firstNameStartsWith, lastName, lastNameStartsWith, limit, middleName, middleNameStartsWith, modifiedSince, nameStartsWith, offset, orderBy, series, stories, suffix);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="suffix">Optional parameter: Filter by suffix or honorific (e.g. Jr., Sr.).</param>
        /// <return>Returns the CreatorDataWrapper response from the API call</return>
        public async Task<CreatorDataWrapper> GetCreatorCollectionByComicIdAsync(
                string comicId,
                string comics = null,
                string firstName = null,
                string firstNameStartsWith = null,
        ...
        public EventDataWrapper GetIssueEventsCollection(
                ...
                string stories = null)
        {
            Task<EventDataWrapper> t = GetIssueEventsCollectionAsync(comicId, characters, creators, limit, modifiedSince, name, nameStartsWith, offset, orderBy, series, stories);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="stories">Optional parameter: Return only events which contain the specified stories (accepts a comma-separated list of ids).</param>
        /// <return>Returns the EventDataWrapper response from the API call</return>
        public async Task<EventDataWrapper> GetIssueEventsCollectionAsync(
                string comicId,
                string characters = null,
                string creators = null,
                string limit = null,
        ...
        /// <param name="offset">Optional parameter: Skip the specified number of resources.</param>
        ...
        public StoryDataWrapper GetComicStoryCollectionByComicId(
                ...
                string series = null)
        {
            Task<StoryDataWrapper> t = GetComicStoryCollectionByComicIdAsync(comicId, characters, creators, events, limit, modifiedSince, offset, orderBy, series);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="series">Optional parameter: Return only stories contained the specified series (accepts a comma-separated list of ids).</param>
        /// <return>Returns the StoryDataWrapper response from the API call</return>
        public async Task<StoryDataWrapper> GetComicStoryCollectionByComicIdAsync(
                string comicId,
                string characters = null,
                string creators = null,
                string events = null,
        ...
        /// <param name="collaborators">Optional parameter: Return only comics in which the specified creators worked together (for example in which BOTH Stan Lee and Jack Kirby did work). Accepts a comma-separated list of ids.</param>
        ...
        /// <param name="noVariants">Optional parameter: Exclude variants (alternate covers, secondary printings, director's cuts, etc.) from the result set. (Acceptable values are: "true")</param>
        /// <param name="offset">Optional parameter: Skip the specified number of resources in the result set.</param>
        ...
        /// <param name="sharedAppearances">Optional parameter: Return only comics in which the specified characters appear together (for example in which BOTH Spider-Man and Wolverine appear). Accepts a comma-separated list of ids.</param>
        ...
        public ComicDataWrapper GetComicsCollection(
                ...
                string upc = null)
        {
            Task<ComicDataWrapper> t = GetComicsCollectionAsync(characters, collaborators, creators, dateDescriptor, dateRange, diamondCode, digitalId, ean, events, format, formatType, hasDigitalIssue, isbn, issn, issueNumber, limit, modifiedSince, noVariants, offset, orderBy, series, sharedAppearances, startYear, stories, title, titleStartsWith, upc);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="upc">Optional parameter: Filter by UPC.</param>
        /// <return>Returns the ComicDataWrapper response from the API call</return>
        public async Task<ComicDataWrapper> GetComicsCollectionAsync(
                string characters = null,
                string collaborators = null,
                string creators = null,
                DateDescriptorEnum? dateDescriptor = null,
